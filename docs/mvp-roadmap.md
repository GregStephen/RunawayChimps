...
**Current technology and rules:** main now declares Unity **2022.3.62f3 (96770f904ca7)** after Greg approved and merged PR #61. Photon PUN and built-in rendering remain unchanged. This is the adopted editor baseline, not a Unity 6 migration. Preserve the two personal Amber cards, visit-local consumption and ten-player target; #45 still owns capacity evidence.
...
**62f3 adoption, September 22:** Greg approved merging PR #61 after a clean editor import/playthrough and a passing Reliability Regression Check. Main now uses 62f3. Remaining Android/Quest/package acceptance stays open under #27; #63 and #64 track defects shown to predate the editor migration.
